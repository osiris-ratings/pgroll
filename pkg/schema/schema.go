...
type Column struct {
	...
	// Identity is "a" (GENERATED ALWAYS) or "d" (GENERATED BY DEFAULT)
	// when the column is an identity column, empty otherwise. Snapshots
	// captured before this field existed lack it even for identity columns.
