	...
	ExecuteTests(t, TestCases{
		{
			...
			afterStart: func(t *testing.T, db *sql.DB, schema string) {
				...
				ColumnMustHaveComment(t, db, schema, "users", migrations.TemporaryName(migrations.MigrationScopeFor("02_set_comment"), "name"), "name of the user")
		...
		},
		{
			...
			afterStart: func(t *testing.T, db *sql.DB, schema string) {
				...
				ColumnMustNotHaveComment(t, db, schema, "users", migrations.TemporaryName(migrations.MigrationScopeFor("02_set_comment"), "name"))
			},
			afterRollback: func(t *testing.T, db *sql.DB, schema string) {
				// The old column should have the old comment.
				ColumnMustHaveComment(t, db, schema, "users", "name", "apples")
		...
		},
		{
			...
			afterStart: func(t *testing.T, db *sql.DB, schema string) {
				...
				ColumnMustHaveComment(t, db, schema, "users", migrations.TemporaryName(migrations.MigrationScopeFor("02_set_comment"), "name"), "apples")
			},
			afterRollback: func(t *testing.T, db *sql.DB, schema string) {
			},
			afterComplete: func(t *testing.T, db *sql.DB, schema string) {
